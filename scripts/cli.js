...
const contractABI = require("../artifacts/contracts/Ethersprovider.sol/Ethersprovider.json").abi;

program
    .name("ethersprovider-cli")
    .description("CLI tool for Ethersprovider smart contract")
    .version("1.0.0");
